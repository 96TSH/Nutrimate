...
public class CustomerServiceImpl implements CustomerService{
    ...
    private void checkifCustomerExistOtherRepository(Customer customer){
        ...
        List<CourseRegistration> courseRegContainer = courseRegistrationRepository.findAllByCustomer(customer);
        ...
        if(!courseRegContainer.isEmpty()){
            courseRegistrationRepository.deleteAllByCustomer(customer);
        }
